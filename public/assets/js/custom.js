(function ($) {
    ...
    $(".rapport_item").on("click", function (e) {
        e.preventDefault();
    ...
    $(".image_item").on("click", function (e) {
        e.preventDefault();
        let xhr = new XMLHttpRequest();
        xhr.onreadystatechange = function () {
            if (this.readyState == 4) {
                ...
                if (data.class) {
                    ...
                    $("#image_modal .modal-body .card .card-body").html(data.class);
                }
            }
        };
        xhr.open("GET", this.href, true);
    ...
    let chart_rapport = document.querySelector("#chart-raport");
    if (chart_rapport) {
        var chart8 = new ApexCharts(chart_rapport, options8);
        chart8.render();
    }
})(jQuery);
